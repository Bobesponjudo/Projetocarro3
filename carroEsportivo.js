...
class CarroEsportivo extends Carro {
     ...
     * @extends Carro
     * @description Representa um carro esportivo, herdando de Carro e adicionando
     *              funcionalidade de Turbo, além de modificar aceleração, frenagem
     *              e velocidade máxima.
     */
    ativarTurbo() {
    ...
    // --- Ações Sobrescritas ---
    /**
         * Acelera o carro esportivo. A aceleração e o consumo de combustível
         * são maiores, especialmente com o turbo ativado.
         * @override
         * @returns {boolean} True se a aceleração ocorreu, false caso contrário.
         */
    ...
    /**
       * Retorna uma string formatada com as informações do carro esportivo,
       * incluindo o status do turbo.
       * @override
